...
_CARD_URL = f"{STATIC_URL_PREFIX}/docker-monitor-card.js"
_WWW_DIR = Path(__file__).parent / "www"


class DockerMonitorDashboardResource(TypedDict):
...
class DockerMonitorCardRegistration:
    """
...
) -> list[DockerMonitorDashboardResource]:
    return [
        cast("DockerMonitorDashboardResource", item) for item in resources.async_items()
    ]
